...
public class StoneDetail implements Serializable{
    ...
    public StoneDetail(List<ModelDetailResult.DataEntity.StoneTypeEntity> stoneTypeItme, List<ModelDetailResult.DataEntity.StoneColorEntity> stoneColorItme, List<PurityEntity> stonePurityItme, List<ModelDetailResult.DataEntity.StoneSpecEntity> stoneSpecItme, List<ModelDetailResult.DataEntity.StoneShapeEntity> stoneShapeItem) {
    ...
    public List<PurityEntity> getStonePurityItme() {
        return stonePurityItme;
    }

    public void setStonePurityItme(List<PurityEntity> stonePurityItme) {
        this.stonePurityItme = stonePurityItme;
    }
