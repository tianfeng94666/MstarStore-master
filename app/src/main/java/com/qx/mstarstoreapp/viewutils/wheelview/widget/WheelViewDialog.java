 ...
 */
package com.qx.mstarstoreapp.viewutils.wheelview.widget;
...
import com.qx.mstarstoreapp.viewutils.wheelview.adapter.ArrayWheelAdapter;
import com.qx.mstarstoreapp.viewutils.wheelview.common.WheelConstants;
import com.qx.mstarstoreapp.viewutils.wheelview.util.WheelUtils;
...
public class WheelViewDialog<T> implements View.OnClickListener {
    ...
    private com.qx.mstarstoreapp.viewutils.wheelview.widget.WheelView<T> mWheelView;

    private com.qx.mstarstoreapp.viewutils.wheelview.widget.WheelView.WheelViewStyle mStyle;
    ...
    private void init() {
        ...
        mWheelView = new com.qx.mstarstoreapp.viewutils.wheelview.widget.WheelView(mContext);
        mWheelView.setSkin(com.qx.mstarstoreapp.viewutils.wheelview.widget.WheelView.Skin.Holo);
        mWheelView.setWheelAdapter(new ArrayWheelAdapter(mContext));
        mStyle = new com.qx.mstarstoreapp.viewutils.wheelview.widget.WheelView.WheelViewStyle();
        mStyle.textColor = Color.GRAY;
        mStyle.selectedTextZoom = 1.2f;
        mWheelView.setStyle(mStyle);

        mWheelView.setOnWheelItemSelectedListener(new com.qx.mstarstoreapp.viewutils.wheelview.widget.WheelView.OnWheelItemSelectedListener<T>() {
            @Override
